      ...
      <div className={styles.itemContainer}>
        ...
        <div className={styles.textContainer}>
          <p>
            ...
            (at time of writing), Chris Ragland.
          </p>
          <p>
            Chris enjoys solving simple derivatives and integrals. He describes
            it as, &lsquo;stretching for the brain.&rsquo;
          </p>
        </div>
      </div>
      <div className={styles.itemContainer}>
        ...
        <div className={styles.textContainer}>
          ...
          <p>The term &lsquo;Use it or loose it&rsquo; exists for a reason.</p>
          <p>
            If a student is taking a semester or two between calculus classes,
            The Daily Derivative is perfect to keep concepts fresh and skills
            sharp.
          </p>
