...
const AboutPage = () => {
  return (
    <>
      <Head>
        <title>About - The Daily Derivative</title>
      </Head>
        ...
        <div className={styles.itemContainer}>
          ...
          <div className={styles.textContainer}>
            ...
            <p>
              ...
              describes it as, &quot;stretching for the brain.&quot;
            </p>
          </div>
        </div>
        <div className={styles.itemContainer}>
          ...
          <div className={styles.textContainer}>
            <p>
              The idea behind The Daily Derivative is to maintain and
              potentially improve a students calculus mastery.
            </p>
